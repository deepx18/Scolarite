...
<aside class="fixed left-0 top-0 h-screen w-64 pt-20 bg-slate-100 dark:bg-slate-950 flex flex-col p-4 space-y-2 tonal-layering">
    ...
    <div class="border-t border-slate-200 dark:border-slate-800 pt-4 space-y-1">
        ...
        <!-- form logout for Admins -->
        <form method="POST" action="{{ route('admin.logout') }}" class="flex items
            -center gap-3 px-4 py-3 text-slate-600 dark:text-slate-400 hover:text-blue-800 dark:hover:text-blue-200 hover:bg-slate-200/50 dark:hover:bg-slate-800/50 rounded-lg transition-all">
            @csrf
