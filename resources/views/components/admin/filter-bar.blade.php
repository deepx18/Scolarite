<form method="GET" action="{{ route('admin.requests.index') }}" class="flex flex-col lg:flex-row lg:items-center gap-4 mb-8">
    <!-- Search Input -->
    <div class="w-full lg:flex-1 bg-surface-container-low p-2 rounded-xl flex items-center">
    ...
    <div class="w-full lg:w-36 shrink-0">
        <button type="submit"
            class="w-full bg-slate-900 text-white font-bold py-3 rounded-full text-sm md:text-base hover:bg-slate-800 transition-colors flex items-center justify-center gap-2">
            <span class="material-symbols-outlined">search</span>
            {{ __('admin.search') }}
        </button>
    </div>
    <!-- Request Type Filter -->
    <div class="w-full lg:w-48 bg-surface-container-low rounded-xl flex items-center px-4">
    ...
    <!-- Action Buttons -->
    <div class="w-full lg:w-36 shrink-0 flex">
        <button type="button"
            ...
            class="w-full bg-surface-container-highest text-on-surface font-bold py-3 rounded-full text-sm md:text-base hover:bg-slate-300 transition-colors flex items-center justify-center gap-2 px-5">
